<template>
    <div class="flex">
        <nav class="hidden md:block bg-gray-600  w-72 h-screen fixed px-1 dark:bg-gray-800">
        <div class="my-5">
    ...
    <header class="bg-gray-200 w-full h-screen ml-0 md:ml-72">
        <div class="h-20 bg-gray-500">
            Lorem ipsum dolor sit, amet consectetur adipisicing el
        </div>
        <div class="h-80 bg-gray-500 static">
            <span class="mx-10 absolute mt-4 text-2xl">Pagina Inicial</span>
         
        </div>
        <div class="mt-5 w-auto h-auto -mt-64 bg-gray-100 mx-1 md:mx-5 rounded-3xl">
            conteudo da pagina<br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
            conteudo da pagina<br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
            <!-- conteudo da pagina<br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/> -->
            <!-- conteudo da pagina<br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
            conteudo da pagina<br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
